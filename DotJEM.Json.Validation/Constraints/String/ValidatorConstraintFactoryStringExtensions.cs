...
namespace DotJEM.Json.Validation.Constraints.String
{
    public static class ConstraintFactoryStringExtensions
    {
        ...
        public static CapturedConstraint Equal(this IBeConstraintFactory self, string value, StringComparison comparison = StringComparison.Ordinal)
            => self.Capture(new StringEqualsJsonConstraint(value, comparison));
    }
}